...
/*
* Method attached to the submit event of forms in the radio-route macro. This function prevents the form submission, and instead sends it as an AJAX request, and then instead sends the user to the page for the route they've picked
*/
